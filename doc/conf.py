...
# -*- coding: utf-8 -*-
#
# kaLB documentation build configuration file, created by
...
project = 'kaLB'
copyright = '2018, Simon Schmitt & Sven Brieden'
...
latex_documents = [
    (master_doc, 'kaLB.tex', 'kaLB Documentation',
...
texinfo_documents = [
    (master_doc, 'kaLB', 'kaLB Documentation',
     author, 'kaLB', 'One line description of project.',
     'Miscellaneous'),
]
